...
class UpdateBarbershopStatusWidget {
  ...
  static void showBottomSheet({
    ...
    List<Map<String, dynamic>> reasons = [
      {'label': 'Invalid Business Documents', 'selected': false.obs},
      {'label': 'Incomplete Profile Information', 'selected': false.obs},
      {'label': 'Unverified Business Address', 'selected': false.obs},
      {'label': 'Inconsistent Contact Information', 'selected': false.obs},
      {'label': 'Missing Documents', 'selected': false.obs},
    ];
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (selectedReasons.isEmpty) {
                            ...
                            controller.updateSingleFieldBarbershop(barbershopId,
                                notes, selectedReasons, barbershopFCM, stat);
                            Get.back();
                          }
                        },
                        child: Text(
